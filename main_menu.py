...
def get_user_choice():
    ...
    while True:
        ...
        if choice in ['a', 'b', 'c', 'd']:
            ...
            console.print(
                "Invalid choice. Please enter a, b, c, d", style="bold green")


def choose_quiz(option):
    if option == '1':
        clear_screen()
        console.print("Welcome to a movie Quiz Game",
                      style="bold green3 underline")
        print()
        return movie_quiz
    elif option == '2':
        clear_screen()
        console.print("Welcome to a science Quiz game!",
        ...
        clear_screen()
        console.print("Invalid Option. Please choose a valid Option",
                      style="sea_green1 underline")
